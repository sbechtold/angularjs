...
app.controller("ListController", ["$log", "filterFilter", function ($log, filterFilter) {
    var vm = this;
    vm.teams = [
    ...
    vm.addTeam = function () {
        var filter = { Name:vm.newTeam.Name };
        var resultShown = filterFilter(vm.teams, filter);
        var resultRestore = filterFilter(vm.deleted, filter);
