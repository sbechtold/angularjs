angular.module("myNgRouter.controllers", ["myNgRouter.filters"])
   ...
   .controllers("HomeController", ["$scope" , function($scope, findByIdFilter) {
       
   }])
   .controllers("DetailController", ["$scope" , "findByIdFilter", "$routeParams", function($scope, findByIdFilter) {
